...
HD_PWD='C:/Users/arman/VivadoProjects/Morse_System/Morse_System.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_levelModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_levelModule.tcl -notrace
