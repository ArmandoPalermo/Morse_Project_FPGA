...
HD_PWD='C:/Users/arman/VivadoProjects/Morse_System/Morse_System.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_levelModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_levelModule.tcl
